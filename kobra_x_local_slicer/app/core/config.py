...
class Settings:
    ...
    def save_config(self) -> None:
        self.data_dir.mkdir(parents=True,exist_ok=True); (self.data_dir/'config.json').write_text(json.dumps({'printer_host':validate_printer_host(self.printer_host),'ha_device_id':self.ha_device_id},indent=2),encoding='utf-8')
